    ...
    @method('PUT')
            ...
            <div class="col-12">
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="naam" name="naam" placeholder="naam" value="{{$user->naam}}"></input>
                </div>
            </div>
            ...
            <div class="col-12">
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="adres" name="adres" placeholder="adres" value="{{$user->adres}}">
                </div>
            </div>
            ...
            <div class="col-12">
                <div class="form-group">
                    ...
                    <input type="number" class="form-control" id="tegoed" name="tegoed" placeholder="tegoed" value="{{$user->tegoed}}">
                </div>
            </div>
